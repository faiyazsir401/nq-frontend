...
const OneOnOneCall = ({ timeRemaining, selectedUser, setSelectedUser,videoRef,remoteVideoRef,toUser,fromUser,remoteStream,localStream,isLocalStreamOff,
  setIsLocalStreamOff,isRemoteStreamOff }) => {
